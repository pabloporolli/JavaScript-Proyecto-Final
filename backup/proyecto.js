...
else
{
    ...
    {
        let nuevaReserva = document.createElement("div");
        nuevaReserva.innerHTML = `
            <button type="button" class="btn btn-dark" id="botonNuevaReserva">¿Desea crear otra reserva?</button>
    `;
        let nuevoBook = document.getElementById("nuevoBook");
        nuevoBook.appendChild(nuevaReserva);

        let botonNuevaReserva = document.getElementById("botonNuevaReserva");
        botonNuevaReserva.addEventListener("click", reset);
    }
